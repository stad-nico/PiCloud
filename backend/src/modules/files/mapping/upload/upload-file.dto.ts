...
export class UploadFileDto {
	...
	public static from(uploadFileBody: UploadFileBody, file: Express.Multer.File, jwt: JwtPayload): UploadFileDto {
		...
		return new UploadFileDto(uploadFileBody.directoryId, filename, file.mimetype, file.size, file.buffer, jwt.user.id);
	}
}
